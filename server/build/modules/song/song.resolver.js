...
exports.SongResolver = {
    Query: {
        getSong: function (parent, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.db.song.findUnique({ where: { song_id: args.song_id } })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); },
        getAllSongs: function (parent, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, database_1.db.song.findMany()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        }); }
    ...
    Mutation: {
        ...
        updateSong: function (parent, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, database_1.db.song.update({
        ...
        deleteSong: function (parent, args, context) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
